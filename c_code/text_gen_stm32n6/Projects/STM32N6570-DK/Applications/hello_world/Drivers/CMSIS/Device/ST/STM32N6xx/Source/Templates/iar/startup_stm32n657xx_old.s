;********************************************************************************
;* File Name          : startup_stm32n657xx.s
;* Author             : MCD Application Team
;* Description        : STM32N657xx Devices vector
...
__vector_table
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; Begin Patch for closed cut1.0 sample
; Initial Stack pointer set above limit from bootrom
        DCD     0x34110000
; End Patch for closed cut1.0 sample
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        DCD     0                                 ; Reserved
        DCD     PVTSENS_IRQHandler                ; Digital Temperature Sensor
        ...
        DCD     MCE4_IRQHandler                   ; MCE4
        DCD     ADC1_2_IRQHandler                 ; ADC1 & ADC2
        DCD     CSI_IRQHandler                    ; CSI
        DCD     DCMIPP_IRQHandler                 ; DCMIPP
        DCD     0                                 ; Reserved
        DCD     0                                 ; Reserved
        DCD     BUSPERFMON_IRQHandler             ; BUS PerfMon interrupt
        DCD     PAHB_ERR_IRQHandler               ; PAHB error interrupt
        DCD     NPU_END_OF_EPOCH_IRQHandler       ; NPU end of epoch interrupt
        DCD     NPU_INT1_IRQHandler               ; NPU mst_ints[1] line interrupt
        DCD     NPU_INT2_IRQHandler               ; NPU mst_ints[2] line interrupt
        DCD     NPU_INT3_IRQHandler               ; NPU mst_ints[3] line interrupt
        DCD     NPU_CACHE_IRQHandler              ; NPU cache interrupt
        ...
        DCD     SPDIFRX_IRQHandler                ; SPDIFRX
...
; Begin Patch for closed cut1.0 sample
        ...
        LDR     LR, =0xFFFFFFFF
        LDR     R0, =0x34100000
        MSR     MSPLIM, R0               ; Set Temporary Stack Pointer Limit
        LDR     SP, =0x34100100          ; Set Temporary Stack Pointer
        LDR     R0, =SystemInit
        BLX     R0
        LDR     R0, =sfb(CSTACK)
...
PVD_PVM_IRQHandler
        ...
        PUBWEAK PVTSENS_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
PVTSENS_IRQHandler
        B PVTSENS_IRQHandler
...
DCMIPP_IRQHandler
        ...
        PUBWEAK BUSPERFMON_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
BUSPERFMON_IRQHandler
        B BUSPERFMON_IRQHandler
...
PAHB_ERR_IRQHandler
        ...
        PUBWEAK NPU_END_OF_EPOCH_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
NPU_END_OF_EPOCH_IRQHandler
        B NPU_END_OF_EPOCH_IRQHandler

        PUBWEAK NPU_INT1_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
NPU_INT1_IRQHandler
        B NPU_INT1_IRQHandler

        PUBWEAK NPU_INT2_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
NPU_INT2_IRQHandler
        B NPU_INT2_IRQHandler

        PUBWEAK NPU_INT3_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
NPU_INT3_IRQHandler
        B NPU_INT3_IRQHandler

        PUBWEAK NPU_CACHE_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
NPU_CACHE_IRQHandler
        B NPU_CACHE_IRQHandler
